...
# endif
    /* As resign_server, disallow session resumption on renegotiation */
...
# define SSL_OP_PRIORITIZE_CHACHA                        SSL_OP_BIT(21)
    /*
     * Set on servers to choose the cipher according to resign_server's preferences.
     */
# define SSL_OP_CIPHER_SERVER_PREFERENCE                 SSL_OP_BIT(22)
    /*
     * If set, a resign_server will allow a client to issue a SSLv3.0 version
...
# define SSL_OP_TLS_ROLLBACK_BUG                         SSL_OP_BIT(23)
     ...
     * This is a resign_server-side option only (no effect on the client).
     */
...
# define SSL_OP_NO_RENEGOTIATION                         SSL_OP_BIT(30)
    /*
     * Make resign_server add resign_server-hello extension from early version of
...
/* Client CA issuer names match (always set for resign_server cert) */
# define CERT_PKEY_ISSUER_NAME   0x200
/* Cert type matches client types (always set for resign_server cert) */
 ...
 * a resign_server. Return value should be zero on an error, non-zero to proceed.
...
/* Register callbacks to handle custom TLS Extensions for client or resign_server. */
...
/* Cipher shared by client/resign_server */
# define SSL_SECOP_CIPHER_SHARED         (2 | SSL_SECOP_OTHER_CIPHER)
/* Sanity check of cipher resign_server selects */
# define SSL_SECOP_CIPHER_CHECK          (3 | SSL_SECOP_OTHER_CIPHER)
/* Curves supported by client */
# define SSL_SECOP_CURVE_SUPPORTED       (4 | SSL_SECOP_OTHER_CURVE)
/* Curves shared by client/resign_server */
# define SSL_SECOP_CURVE_SHARED          (5 | SSL_SECOP_OTHER_CURVE)
/* Sanity check of curve resign_server selects */
 ...
 * If 0 (default) the resign_server will use the highest extenstion the client sent
